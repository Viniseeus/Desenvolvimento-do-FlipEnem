...
<body>
    ...
    <form class="" method="POST" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="ml-3 col-4">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="ml-3 form-control" min="2009" max="2100" name="anoquest" id="anoquest" required>
                </div>
            </div>
        </div>
        ...
        <div class="ml-3 "><label class="form-label my-3 altc">Alternativa correta:</label>
